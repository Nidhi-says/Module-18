...
## OUTPUT
![image](https://github.com/user-attachments/assets/c3277296-dde3-4a66-acf9-ce9bdf414c4c)

## RESULT
Thus a Python program to **count the number of triangles** present in an **undirected graph** using matrix operations is implemented successfully.
